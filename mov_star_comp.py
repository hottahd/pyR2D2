...
for n in tqdm(range(n0,n1)):
    ...
    im1 = ax1.pcolormesh(d02.p['y']*lf,d02.p['z']*lf,d02.qt['in'].T/in02_0,vmin=0.95,vmax=1.03)
    im2 = ax2.pcolormesh(d06.p['y']*lf,d06.p['z']*lf,d06.qt['in'].T/in06_0,vmin=0.85,vmax=1.09)
    im3 = ax3.pcolormesh(d10.p['y']*lf,d10.p['z']*lf,d10.qt['in'].T/in10_0,vmin=0.5,vmax=1.3)

    ax1.set_ylabel('Mm')
    titles = [
        r'$0.2M_\odot:~I/I_0=0.95-1.03$',
        r'$0.6M_\odot:~I/I_0=0.85-1.09$',
        r'$M_\odot:~I/I_0=0.5-1.3$'
    ]
