...
IS_PREVIEW = os.environ.get("SPHINX_PREVIEW", "0") == "1"

# Ensure site-packages are available when Sphinx is launched in an isolated environment
site.main()
...
if IS_PREVIEW:
    exclude_patterns += ['**/automodapi*', '**/generated/*']  # automodapi関連のファイルを除外
...
automodapi_inheritance_diagram = not IS_PREVIEW
autosummary_generate = not IS_PREVIEW
...
def setup(app):
    ...
    if not IS_PREVIEW:
        app.connect('builder-inited', run_pyR2D2)
